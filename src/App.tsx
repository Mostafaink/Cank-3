...
function Sidebar({ active, setActive, userId, onAdminClick }: { active: string; setActive: (a: string) => void; userId: string; onAdminClick: () => void }) {
  const items = [
  ...
  return (
    <aside className="w-64 bg-neutral-900 text-neutral-200 p-4 flex flex-col min-h-screen">
      ...
      <div className="mt-auto pt-4 border-t border-neutral-700 flex-shrink-0">
        <button
        ...
        <main className="flex-1 bg-white">
          ...
          {active === "credit" && (
            <div className="max-w-4xl mx-auto p-6 text-center">
              ...
              <Modal open={activateOpen} onClose={() => setActivateOpen(false)} title={isCompact ? renderAcronym(Labels.ActivateReceivables) : Labels.ActivateReceivables.full} width={480}>
                <div className="flex gap-2 justify-center">
              ...
              <Modal open={recheckOpen} onClose={() => setRecheckOpen(false)} title={isCompact ? renderAcronym(Labels.RecheckReceivables) : Labels.RecheckReceivables.full} width={480}>
                <div className="flex gap-2 justify-center">
                  <button className="rounded-xl px-4 py-2 font-bold bg-green-600 text-white" onClick={async () => {
              ...
              <Modal open={cashOpen} onClose={() => setCashOpen(false)} title={isCompact ? renderAcronym(Labels.Cash) : Labels.Cash.full} width={480}>
                <div className="space-y-3">
              ...
              <Modal open={moreOpen} onClose={() => setMoreOpen(false)} title={isCompact ? renderAcronym(Labels.MoreOptions) : Labels.MoreOptions.full} width={480}>
                <div className="space-y-3">
              ...
              <Modal open={selectMoreOpen} onClose={() => setSelectMoreOpen(false)} title={isCompact ? renderAcronym(Labels.SelectMoreOptions) : Labels.SelectMoreOptions.full} width={480}>
                <div className="space-y-3">
                  <div className="text-neutral-600"></div>
                  <div className="flex gap-2 justify-center">
                    <button className="rounded-xl px-4 py-2 font-bold bg-green-600 text-white" onClick={async () => {
              ...
              <Modal open={selectTimeOpen} onClose={() => setSelectTimeOpen(false)} title={isCompact ? renderAcronym(Labels.SelectMoreTime) : Labels.SelectMoreTime.full} width={480}>
                <div className="space-y-3">
                  <div className="text-neutral-600"></div>
                  <div className="flex gap-2 justify-center">
                    <button className="rounded-xl px-4 py-2 font-bold bg-green-600 text-white" onClick={async () => {
              ...
              <Modal open={extendOpen} onClose={() => setExtendOpen(false)} title={isCompact ? renderAcronym(Labels.ExtendTime) : Labels.ExtendTime.full} width={480}>
                <div className="space-y-3">
                  <div className="text-neutral-600"></div>
                  <div className="flex gap-2 justify-center">
                    <button className="rounded-xl px-4 py-2 font-bold bg-green-600 text-white" onClick={async () => {
